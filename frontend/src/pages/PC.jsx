...
const PC = () => {
    ...
    return (<>
        <div className="max-w-5xl mx-auto mt-10 p-8 bg-white rounded-3xl shadow-xl border border-gray-200">
            ...
            <div>
                {pc.estado_pc && pc.estado_pc !== "funcional" ? (pc.estado_pc === "reparacion" ? (<span
                    className="ml-2 px-3 py-1 bg-red-100 border border-red-400 text-red-700 font-bold rounded-lg flex items-center gap-2 shadow-md">
                    <span className="text-xl">⚠️</span>
                    {pc.estado_pc}
                </span>) : (<span className="ml-2 text-gray-700 font-semibold">
                    {pc.estado_pc}
                </span>)) : null}
            </div>
